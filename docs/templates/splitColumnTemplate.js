...
<div style="width:100%;height:100%;">
	<div class="columnHolder" style="width:100%; height:calc(100% - 90px); position:relative;">
		<div id="middleBit" style="min-height:calc(100% - 60px); width:70%" class="centered">
			<div style="margin-top:10px;" class="columnHolder centered" id="putTheScriptsHereBaka">
				
			`+ document.getElementById("mainColumnContent").innerHTML +`
			</div>
		</div>
		<div id="middleBit" style="min-height:calc(100% - 60px); width:20%;">
			`+ document.getElementById("infoColumnContent").innerHTML +`
		</div>
	</div>
</div>
`;
