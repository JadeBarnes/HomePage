...
class Tile {
	...
	Draw(){
		...
		if(this.health/this.maxHealth <= .25){
			ctx.drawImage(damageTexture, 52 * 3, 0, tileSize,tileSize, this.x,this.y, tileSize+1,tileSize+1);
		} else if (this.health/this.maxHealth <= .50) {
			ctx.drawImage(damageTexture, 52 * 2, 0, tileSize,tileSize, this.x,this.y, tileSize+1,tileSize+1);
		} else if (this.health/this.maxHealth <= .75) {
			ctx.drawImage(damageTexture, 52 * 1, 0, tileSize,tileSize, this.x,this.y, tileSize+1,tileSize+1);
		} else if (this.health < this.maxHealth) {
			ctx.drawImage(damageTexture, 52 * 0, 0, tileSize,tileSize, this.x,this.y, tileSize+1,tileSize+1);
		};
	}
